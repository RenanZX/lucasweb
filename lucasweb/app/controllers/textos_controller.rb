class TextosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @texto.save
        format.html { redirect_to @texto, notice: 'Texto publicado com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @texto.update(texto_params)
        format.html { redirect_to @texto, notice: 'Texto atualizado com sucesso!' }
  ...
  def destroy
    @texto.destroy
    respond_to do |format|
      format.html { redirect_to textos_url, notice: 'Texto apagado com sucesso!' }
  ...
  private
    ...
    def texto_params
      params.require(:texto).permit(:title, :body)
    end
end
